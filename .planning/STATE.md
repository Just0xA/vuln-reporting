...
Last activity: 2026-06-03 — Completed quick task 260603-c6u: relocated canonical cron-scheduling setup + `warm_cache` timing rules into DEPLOYMENT.md (single source of truth); trimmed RUNBOOK.md to day-to-day operator actions with cross-references. Docs-only.
