...
Last activity: 2026-06-02 — Completed quick task 260602-jqg: updater now restores service-account ownership on root-run installs (`fix_release_ownership`, exit 16) + DEPLOYMENT.md invocation-models/proxy docs. UNVERIFIED until confirmed on the RHEL/Rocky VM.
